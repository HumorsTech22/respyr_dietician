  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        if (client == null) return _errorScreen('Missing or invalid client profile data.');
        if (m['strategy'] != null && strategy == null) return _errorScreen('Missing or invalid diet plan strategy data.');
      ...
      pageBuilder: (context, state) {
        ...
        if (m == null) {
          return const NoTransitionPage(
            child: Scaffold(body: Center(child: Text('Missing or invalid params.'))),
          );
        }
        ...
        if (client == null) {
          return const NoTransitionPage(
            child: Scaffold(body: Center(child: Text('Missing or invalid client profile data.'))),
          );
        }

        if (m['strategy'] != null && strategy == null) {
          return const NoTransitionPage(
            child: Scaffold(body: Center(child: Text('Missing or invalid diet plan strategy data.'))),
          );
        }
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) {
        ...
        if (extra is ExhaleScreenParams) {
          ...
          if (m == null) return NoTransitionPage(child: _errorScreen('Missing or invalid navigation parameters.'));
    ...
    GoRoute(
      ...
      builder: (context, state) {
        final m = _asMap(state.extra);
        if (m == null) return ErrorScreen(errorMessage: 'Missing or invalid route arguments');
        ...
        if (client == null) return ErrorScreen(errorMessage: 'ClientProfileModel is missing or invalid');
        if (strategy == null) return ErrorScreen(errorMessage: 'DietPlanStrategyModel is missing or invalid');
    ...
    ShellRoute(
      ...
      routes: [
        GoRoute(
          ...
          builder: (context, state) {
            final client = state.extra as ClientProfileModel;
            return PracticeTestScreen(clientProfileModel: client);
          },
          routes: [
            GoRoute(
            ...
            GoRoute(
              ...
              builder: (context, state) {
                final client = state.extra as ClientProfileModel;
                return PracticeTestBluetoothDeviceConnectivity(clientProfileModel: client);
              },
            ),
            GoRoute(
              ...
              builder: (context, state) {
                ...
                return PracticeTestInhaleScreen(practiceTestInhaleParams: params);
              },
            ),
          ],
        ),
