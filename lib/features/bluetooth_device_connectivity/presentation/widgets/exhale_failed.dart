      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(child: Image.asset("assets/images/device_connection/img_inhale_exhale_screen.png",),),
            SizedBox(
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: rh(context: context, px: 37)),
            Expanded(child: Image.asset("assets/images/device_connection/img_exhale_timeout.png",),),
            SizedBox(
              width: double.infinity,
              child: ElevatedButton(
                  onPressed: (){
