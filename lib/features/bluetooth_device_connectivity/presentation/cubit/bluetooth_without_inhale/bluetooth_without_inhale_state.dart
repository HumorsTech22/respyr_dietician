class BluetoothWithoutInhaleState {
  final bool isReady;
  ...
  const BluetoothWithoutInhaleState({
    this.isReady = false,
  ...
  BluetoothWithoutInhaleState copyWith({
    bool? isReady,
    bool? isConnected,
    String? receivedData,
    String? error,
    ...
    return BluetoothWithoutInhaleState(
      ...
      holdBreathViolation:
      holdBreathViolation ?? this.holdBreathViolation,
      navigateToDashboard:
