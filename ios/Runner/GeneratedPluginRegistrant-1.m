...
#if __has_include(<simple_horizontal_calendar/HorizontalCalendarPlugin.h>)
#import <simple_horizontal_calendar/HorizontalCalendarPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [HorizontalCalendarPlugin registerWithRegistrar:[registry registrarForPlugin:@"HorizontalCalendarPlugin"]];
